...
export const SCENES = [
  ...
  { id: 'themes',  tts: '縁取り、ボックス、ネオン、シャドウ。テーマを選ぶだけで、かわいくも、かっこよくも。縁取りは外側にだけ、なめらかに太くなるので、文字がつぶれません。' },
  { id: 'obs',     tts: 'OBSとの連携もかんたん。OBSのWebSocketを有効にして、パスワードを入れて接続。「字幕を追加」を押すだけ。背景は透過、クロマキーは不要です。' },
